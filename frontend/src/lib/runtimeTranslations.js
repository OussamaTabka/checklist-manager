...
const PHRASES = {
  ...
  common_show_filters: { en: 'Show Filters', fr: 'Afficher les filtres', ar: 'إظهار عوامل التصفية' },
  common_hide_filters: { en: 'Hide Filters', fr: 'Masquer les filtres', ar: 'إخفاء عوامل التصفية' },
  common_previous: { en: 'Previous', fr: 'Precedent', ar: 'السابق' },
  common_next: { en: 'Next', fr: 'Suivant', ar: 'التالي' },
  common_clear_all: { en: 'Clear all', fr: 'Tout effacer', ar: 'مسح الكل' },
  common_category: { en: 'Category', fr: 'Categorie', ar: 'الفئة' },
  common_items: { en: 'Items', fr: 'Elements', ar: 'العناصر' },
  common_go_previous_page: { en: 'Go to previous page', fr: 'Aller a la page precedente', ar: 'الانتقال الى الصفحة السابقة' },
  common_go_next_page: { en: 'Go to next page', fr: 'Aller a la page suivante', ar: 'الانتقال الى الصفحة التالية' },
  ...
  projects_manage_subtitle: {
    en: 'Manage testing projects, assign checklists and testers, and track execution progress.',
    fr: 'Gerez les projets de test, assignez des checklists et des testeurs, et suivez la progression.',
    ar: 'قم بإدارة مشاريع الاختبار، وتعيين قوائم التحقق والمختبرين، وتتبع تقدم التنفيذ.',
  },
  projects_project_list: { en: 'Project List', fr: 'Liste des projets', ar: 'قائمة المشاريع' },
  projects_no_projects_filtered: {
    en: 'No projects found with current filters.',
    fr: 'Aucun projet trouve avec les filtres actuels.',
    ar: 'لم يتم العثور على مشاريع وفق عوامل التصفية الحالية.',
  },

  checklists_search_placeholder: { en: 'Search checklists...', fr: 'Rechercher des checklists...', ar: 'ابحث في قوائم التحقق...' },
  checklists_create: { en: 'Create Checklist', fr: 'Creer une checklist', ar: 'إنشاء قائمة تحقق' },
  checklists_list_title: { en: 'Checklist list', fr: 'Liste des checklists', ar: 'قائمة قوائم التحقق' },
  checklists_loading: { en: 'Loading checklists...', fr: 'Chargement des checklists...', ar: 'جاري تحميل قوائم التحقق...' },
  checklists_no_items: { en: 'No checklists found.', fr: 'Aucune checklist trouvee.', ar: 'لم يتم العثور على قوائم تحقق.' },
  ...
  users_none_found: { en: 'No users found.', fr: 'Aucun utilisateur trouve.', ar: 'لم يتم العثور على مستخدمين.' },
  ...
  stories_project_context: { en: 'Project Context', fr: 'Contexte du projet', ar: 'سياق المشروع' },
  stories_linked_to_project: { en: 'User stories linked to', fr: 'User stories liees a', ar: 'قصص المستخدم المرتبطة بـ' },
  stories_view_project: { en: 'View Project', fr: 'Voir le projet', ar: 'عرض المشروع' },
  stories_project_linked: { en: 'Linked project:', fr: 'Projet lie:', ar: 'المشروع المرتبط:' },
  stories_checklist_links: { en: 'Checklist links', fr: 'Liens checklist', ar: 'روابط قوائم التحقق' },
  stories_view_project_short: { en: 'View Project', fr: 'Voir Projet', ar: 'عرض المشروع' },

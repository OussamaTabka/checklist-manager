...
class ChecklistGenerationAgentService
{
    ...
    public function generateDraftForUserStory(UserStory $userStory): array
    {
        ...
        return DB::transaction(function () use ($userStory, $recommendations, $generation) {
            ...
            $userStory->checklists()->attach($checklist->id, [
                ...
                'relevance_score' => $recommendations['summary']['best_score'] ?? null,
                'link_type' => 'agent_generated',
            ]);

            return [
                'message' => 'Checklist draft generated by agent',
                ...
                'user_story' => $userStory->load(['creator', 'checklists.items']),
    ...
    {
        $action = $recommendations['summary']['recommended_action'] ?? 'create_new_draft';
